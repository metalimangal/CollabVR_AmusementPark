...
public class EscapeManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        canvas = player.transform.GetChild(0).GetChild(0).GetChild(0).GetComponent<Canvas>();
    ...
    void Update()
    {
        ...
        if ((timeRemaining > 0.0f && timeRemaining < timeTotal * 0.4f) || board.GetFoundCount() >= 6)
        {
            ...
            if (board.voteTotal >= 4)
            {
                ...
                if (localRole == ROLE_DETECTIVE)
                {
                    ...
                    if (RightButtonDown(CommonUsages.primaryButton))
                        board.Decide(1);
                    else if (RightButtonDown(CommonUsages.secondaryButton))
                        board.Decide(2);
                    else if (LeftButtonDown(CommonUsages.primaryButton))
                        board.Decide(3);
                    else if (LeftButtonDown(CommonUsages.secondaryButton))
                        board.Decide(4);
                }
        ...
        if (showRole)
        {
            Sprite sprite = Resources.Load<Sprite>("escaperoom2/Katerina");
            string text = "";
            if (localRole == ROLE_MOTHER)
            {
                sprite = Resources.Load<Sprite>("escaperoom2/Katerina");
            ...
            {
                sprite = Resources.Load<Sprite>("escaperoom2/Parva");
            ...
            {
                sprite = Resources.Load<Sprite>("escaperoom2/Detective");
            ...
            {
                sprite = Resources.Load<Sprite>("escaperoom2/Christian");
        ...
        if (showInfo)
        {
            if (RightButtonDown(CommonUsages.secondaryButton))
            {
                // Found
                string boardInfo = "\n";
            ...
            else if (localRole == ROLE_MOTHER && LeftButtonDown(CommonUsages.secondaryButton))
            {
                // Hide
    ...
    {
        Sprite sprite = Resources.Load<Sprite>("escaperoom2/coffee");
        string info = "item";
        if (itemId == ITEM_COFFEE)
        {
            sprite = Resources.Load<Sprite>("escaperoom2/coffee");
        ...
        {
            sprite = Resources.Load<Sprite>("escaperoom2/contract");
        ...
        {
            sprite = Resources.Load<Sprite>("escaperoom2/antidote");
        ...
        {
            sprite = Resources.Load<Sprite>("escaperoom2/photo");
