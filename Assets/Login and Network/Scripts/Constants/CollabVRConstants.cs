...
public class CollabVRConstants
{
    public const string MAP_TYPE_KEY = "map";
    public const string MAP_TYPE_VALUE_SOCIAL_SPACE = "social_space";
    public const string MAP_TYPE_VALUE_ESCAPE_ROOM1 = "escape_room1";
