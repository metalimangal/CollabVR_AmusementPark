...
public class AvatarSelectionManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (PhotonNetwork.LocalPlayer.CustomProperties.TryGetValue(CollabVRConstants.AVATAR_SELECTION_NUMBER, out storedAvatarSelectionNumber))
        {
    ...
    private void LoadAvatarModelAt(int avatarIndex)
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable() { { CollabVRConstants.AVATAR_SELECTION_NUMBER,avatarSelectionNumber } };
